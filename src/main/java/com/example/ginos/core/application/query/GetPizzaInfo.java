...
public class GetPizzaInfo {
    ...
    private void initializeLists(){
        ...
        allPizzas.put("pepperoni", new Pizza("pepperoni", pepperoniPizzaIngredients,  8.99) );
        allPizzas.put("kebab", new Pizza("kebab", kebabPizzaIngredients,  8.99) );
        allPizzas.put("ginos", new Pizza("ginos", ginosPizzaIngredients,  8.99) );
