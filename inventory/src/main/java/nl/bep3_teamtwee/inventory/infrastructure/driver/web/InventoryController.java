package nl.bep3_teamtwee.inventory.infrastructure.driver.web;

import nl.bep3_teamtwee.inventory.core.application.IngredientsCommandHandler;
import nl.bep3_teamtwee.inventory.core.application.IngredientsQueryHandler;
import nl.bep3_teamtwee.inventory.core.application.command.BuyStockForIngredientWithId;
import nl.bep3_teamtwee.inventory.core.application.command.DeleteIngredient;
import nl.bep3_teamtwee.inventory.core.application.command.RegisterIngredient;
import nl.bep3_teamtwee.inventory.core.application.command.UpdateIngredient;
...
import nl.bep3_teamtwee.inventory.infrastructure.driver.web.request.RegisterIngredientRequest;
import nl.bep3_teamtwee.inventory.infrastructure.driver.web.request.UpdateIngredientRequest;
